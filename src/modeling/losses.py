raise DeprecationWarning("Losses are now implemented in the layers package.")
...
# class VICRegLoss:
#    """Wrapper for the vicreg loss function"""
#    def __init__(self, sim_loss_weight=25., var_loss_weight=25., cov_loss_weight=1.):
